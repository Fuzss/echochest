...
public class EchoChestClient implements ClientModConstructor {
    ...
    public void onRegisterBlockEntityRenderers(BlockEntityRenderersContext context) {
        context.registerBlockEntityRenderer(ModRegistry.ECHO_CHEST_BLOCK_ENTITY_TYPE.value(), ChestRenderer::new);
    }

    @Override
    public void onRegisterBuiltinModelItemRenderers(BuiltinModelItemRendererContext context) {
        final EchoChestBlockEntity echoChest = new EchoChestBlockEntity(BlockPos.ZERO, ModRegistry.ECHO_CHEST_BLOCK.value().defaultBlockState());
        ...
        }, ModRegistry.ECHO_CHEST_BLOCK.value());
    }
}
